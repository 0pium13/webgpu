// Self-contained ffmpeg.wasm module worker.
// Inlined from @ffmpeg/ffmpeg 0.12.15 dist/esm (worker.js + const.js + errors.js)
// so it can be served same-origin without a bundler. Loaded as a module worker;
// importScripts throws here, so the catch path import()s the ESM core blob.
